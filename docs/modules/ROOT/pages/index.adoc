...
If you want to use this extension, you need to add the `io.quarkiverse.chappie:quarkus-chappie` extension first to your build file.
...
include::includes/quarkus-chappie.adoc[leveloffset=+1, opts=optional]
