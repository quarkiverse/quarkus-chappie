...
final class LastExceptionBroadcastBuildItem extends SimpleBuildItem {

    private final BroadcastProcessor<LastException> lastExceptionBroadcastProcessor;

    public LastExceptionBroadcastBuildItem(BroadcastProcessor<LastException> lastExceptionBroadcastProcessor) {
